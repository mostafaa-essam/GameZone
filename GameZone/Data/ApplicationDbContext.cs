...
namespace GameZone.Data
{
    public class ApplicationDbContext:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(DeviceConfigurations).Assembly);
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(GameDeviceConfigurations).Assembly);
            ...
            modelBuilder.Entity<Device>()
                .HasData(new Device[]
                {
                    ...
                    new Device{Id=3,Name="Nitendo Switch",Icon="bi bi-nintendo-switch"},
